...
//  cloud_viewer_.addArrow (getPointXYZ(point_x), getPointXYZ(initial_point), 1.0f, 0.0f, 0.0f, false, name);
  const std::string tmpy = sy.str();
  name = tmpy.c_str();
  cloud_viewer_.removeShape(name);
...
//  cloud_viewer_.addArrow (getPointXYZ(point_y), getPointXYZ(initial_point), 0.0f, 1.0f, 0.0f, false, name);
  const std::string tmpz = sz.str();
  name = tmpz.c_str();;
  cloud_viewer_.removeShape(name);
...
//  cloud_viewer_.addArrow (getPointXYZ(point_z), getPointXYZ(initial_point), 0.0f, 0.0f, 1.0f, false, name);
